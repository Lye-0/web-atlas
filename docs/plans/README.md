...
- [ローカル開発・検証CLIの追加計画](2026-09-14-local-development-cli-expansion.md) — Wrangler周辺の5 CLIを実装済み。[実装・検証記録](2026-09-14-local-development-cli-review.md)、[Playwright MCP検証](2026-09-16-local-cli-playwright-mcp-review.md)。
...
- [実装進捗・停止履歴](2026-09-12-dictionary-analyzer-expansion-progress.md) — 最新判定を冒頭に明示し、停止時の記録を保持。
